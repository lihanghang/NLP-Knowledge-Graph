...
WORD2VEC_MODEL = '/home/hanghangli/work/wiki_word2vec_50.bin'
# 　模型格式为bin
WORD2VEC_FORMAT = 'bin'
...
L2_REG_LAMBDA = 0.0
# 原始训练文件
TRAINING_FILES_RAW = '/home/hanghangli/桌面/KG/Field-Knowledge-Graph/datasets/text-similarity/atec_nlp_sim_train.csv'
# 隐藏层单元数
HIDDEN_UNITS = 128
